...
class Assignment(models.Model):
    ...
    course = models.ForeignKey('Course', models.SET_NULL, related_name='assignments')
    ...
    gradingScheme = models.ForeignKey('GradingScheme', models.SET_NULL, related_name="assignments", verbose_name="grading scheme", blank=True, null=True, help_text="Grading scheme for this assignment. Leave empty to have an ungraded assignment.")
