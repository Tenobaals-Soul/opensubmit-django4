...
class SubmissionTestResult(models.Model):
    ...
    submission_file = models.ForeignKey('SubmissionFile', models.SET_NULL, related_name="test_results")
    machine = models.ForeignKey('TestMachine', models.SET_NULL, related_name="test_results")
