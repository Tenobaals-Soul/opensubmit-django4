...
class Submission(models.Model):
    ...
    assignment = models.ForeignKey('Assignment', models.CASCADE, related_name='submissions')
    submitter = models.ForeignKey(User, models.CASCADE, related_name='submitted')
    ...
    file_upload = models.ForeignKey(
        'SubmissionFile', models.CASCADE, related_name='submissions', blank=True, null=True, verbose_name='New upload')
    created = models.DateTimeField(auto_now_add=True, editable=False)
    modified = models.DateTimeField(
        auto_now=True, editable=False, blank=True, null=True)
    grading = models.ForeignKey('Grading', models.CASCADE, blank=True, null=True)
