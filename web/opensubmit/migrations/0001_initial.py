    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(related_name='courses', on_delete=models.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('tutors', models.ManyToManyField(related_name='courses_tutoring', null=True, to=settings.AUTH_USER_MODEL, blank=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('title', models.CharField(max_length=200)),
                ('gradings', models.ManyToManyField(related_name='schemes', to='opensubmit.Grading')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assignment', models.ForeignKey(related_name='submissions', on_delete=models.CASCADE, to='opensubmit.Assignment')),
                ('authors', models.ManyToManyField(help_text=b'', related_name='authored', to=settings.AUTH_USER_MODEL)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('replaced_by', models.ForeignKey(blank=True, on_delete=models.CASCADE, to='opensubmit.SubmissionFile', null=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('courses', models.ManyToManyField(related_name='participants', null=True, to='opensubmit.Course', blank=True)),
        ...
        migrations.AddField(
            ...
            name='machine',
            field=models.ForeignKey(related_name='test_results', on_delete=models.CASCADE, to='opensubmit.TestMachine'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='submissiontestresult',
            name='submission_file',
            field=models.ForeignKey(related_name='test_results', on_delete=models.CASCADE, to='opensubmit.SubmissionFile'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='submission',
            name='file_upload',
            field=models.ForeignKey(related_name='submissions', on_delete=models.CASCADE, blank=True, to='opensubmit.SubmissionFile', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='submission',
            name='grading',
            field=models.ForeignKey(blank=True, on_delete=models.CASCADE, to='opensubmit.Grading', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='submission',
            name='submitter',
            field=models.ForeignKey(related_name='submitted', on_delete=models.CASCADE, to=settings.AUTH_USER_MODEL),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='assignment',
            name='course',
            field=models.ForeignKey(related_name='assignments', on_delete=models.CASCADE, to='opensubmit.Course'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='assignment',
            name='gradingScheme',
            field=models.ForeignKey(related_name='assignments', on_delete=models.CASCADE, to='opensubmit.GradingScheme'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='assignment',
