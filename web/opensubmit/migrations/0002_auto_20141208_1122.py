...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='assignment',
            name='gradingScheme',
            field=models.ForeignKey(related_name='assignments', verbose_name='grading scheme', to='opensubmit.GradingScheme', on_delete=models.CASCADE),
        ),
        migrations.AlterField(
            model_name='assignment',
            name='hard_deadline',
        ...
        migrations.AlterField(
            model_name='course',
            name='owner',
            field=models.ForeignKey(on_delete=models.CASCADE, related_name='courses', to=settings.AUTH_USER_MODEL, help_text='Only this user can change the course details and create new assignments.'),
        ),
        migrations.AlterField(
            model_name='course',
            name='tutors',
        ...
        migrations.AlterField(
            model_name='submission',
            name='file_upload',
            field=models.ForeignKey(on_delete=models.CASCADE, related_name='submissions', verbose_name='New upload', blank=True, to='opensubmit.SubmissionFile', null=True),
        ),
        migrations.AlterField(
            model_name='submission',
            name='grading_file',
        ...
        migrations.AlterField(
            model_name='submissionfile',
            name='replaced_by',
            field=models.ForeignKey(on_delete=models.CASCADE, blank=True, editable=False, to='opensubmit.SubmissionFile', null=True),
        ),
        migrations.AlterField(
