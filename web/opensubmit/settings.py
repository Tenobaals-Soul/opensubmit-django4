...
config = Config((
    ...
    ('/etc/opensubmit/settings.ini', False),  # Linux production system
...
if LOGIN_OPENID:
    AUTHENTICATION_BACKENDS.append('opensubmit.social.open_id.OpenIdAuth',)
...
if LOGIN_OIDC:
    AUTHENTICATION_BACKENDS.append('opensubmit.social.oidc.OpenIdConnectAuth',)
...
if LOGIN_SHIB:
    AUTHENTICATION_BACKENDS.append('opensubmit.social.apache.ModShibAuth',)
